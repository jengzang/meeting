...
/**
 * Derive key from password with PBKDF2 and decrypt both datasets.
 * Must be called (and awaited) before startMap().
 */
export async function initFullData(password) {
